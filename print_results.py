...
#     if print_incorrect_dogs == True and (results_stats_dic['n_dogs_img'] + results_stats_dic['n_notdogs_img'] != results_stats_dic['n_images']):
#         for key in results_dic:
#             if sum(results_dic[key][3:]) == 1:
#                 print('\nMISCLASSIFIED DOGS: \n Pet Image Label?: {} \n Classifier Label?: {}'.format(results_dic[key][0], results_dic[key][1]))
                
#     if print_incorrect_breed == True and (results_stats_dic['n_dogs_img'] != results_stats_dic['n_dogs_img']):
#         for key in results_dic:   
